...
# (can use non-exported fcn attach.tract.geometry, though this has a dependency on
# divDat that isn't great from portability perspective
...
Wrapper_gen.tract.div.measures(cz = "09100",
                               divs = list(hwys = hwys))
